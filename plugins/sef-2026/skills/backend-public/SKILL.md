---
name: backend-public
description: 공공 프로젝트 백엔드 개발. Spring Boot 2.7 + MyBatis + eGovFrame. controller/service/mapper 패턴의 모듈 기반 아키텍처. GET/POST만 허용. 공공 프로젝트 백엔드 개발 시 사용.
---
...
| auditlog | `modules/auditlog/` | Audit log recording (no controller, @AuditLog annotation) |
